<?php
/**
 * Archive template for the tcb-news-category taxonomy
 *
 * @package tcb24
 */
	...
	<div class="inner">
		<div class="container">
			<div class="twelve columns centre">
				<h1><?php echo esc_html__( 'Category:', '3cb24' ); ?> <?php single_term_title( '&nbsp;' ); ?></h1>
			</div>
		</div>
	</div>
</div>
		...
		<div class="post white" id="post-<?php the_ID(); ?>" >
			...
			<div class="padded">
				...
				<p class="postmetadata clear">
					<span class="blogcat">Posted in <?php the_terms( get_the_ID(), 'tcb-news-category', '', ', ' ); ?></span>
